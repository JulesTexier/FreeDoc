...
ActiveRecord::Schema.define(version: 2020_10_22_152723) do
  ...
  create_table "joints", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["doctor_id"], name: "index_joints_on_doctor_id"
    t.index ["specialty_id"], name: "index_joints_on_specialty_id"
  end
